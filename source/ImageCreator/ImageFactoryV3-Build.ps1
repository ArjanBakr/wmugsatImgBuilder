...
#Start DHCP server
& 'E:\ImageCreator\DHCPServer\dhcpsrv.exe' -runapp
...
#Inititial Settings
Clear-Host
$Log = "E:\ImageCreator\Logging\log.txt"
$XMLFile = "E:\ImageCreator\ImageFactoryV3.xml"
$Solution = "IMF32"
...
Import-Module 'E:\Program Files\Microsoft Deployment Toolkit\Bin\MicrosoftDeploymentToolkit.psd1' -ErrorAction Stop -WarningAction Stop
Import-Module PsIni.psm1 -ErrorAction Stop -WarningAction Stop
...
try
{
	Get-Process -Name dhcpsrv | stop-process -force
}
catch
{}
